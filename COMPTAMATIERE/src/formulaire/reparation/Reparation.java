...
REPARATION r=new REPARATION();
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-857)/2, (screenSize.height-477)/2, 857, 477);
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        // TODO add your handling code here:
        try {
         table.setModel(r.getDefaulTableModel("SELECT idREPARATION, LIBPRESTATAIRE AS PRESTATAIRE, LIBREPARATION AS NATURE,LIBBUR AS BUREAU,LIBARTICLE AS ARTICLE, MONTANT, "+
                 "DATEREPARATION FROM REPARATION,PRESTATAIRE,IMMOBILISATIONMATERIEL,BUREAU,ARTICLE WHERE REPARATION.IDPRESTATAIRE=PRESTATAIRE.IDPRESTATAIRE AND "+
