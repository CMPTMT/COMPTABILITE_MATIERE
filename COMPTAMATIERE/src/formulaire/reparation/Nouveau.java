...
public class Nouveau extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtCodeMateriel, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setBounds((screenSize.width-942)/2, (screenSize.height-547)/2, 942, 547);
    ...
    private void tableMaterielServiceMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMaterielServiceMouseClicked
     txtIdImmo.setText(tableMaterielService.getValueAt(tableMaterielService.getSelectedRow(), r.getColumnByName(tableMaterielService, "idimmobilisationmateriel")).toString());
     ...
     txtCodeMateriel.setText(tableMaterielService.getValueAt(tableMaterielService.getSelectedRow(), r.getColumnByName(tableMaterielService, "codemateriel")).toString());
     txtArticle.setText(tableMaterielService.getValueAt(tableMaterielService.getSelectedRow(), r.getColumnByName(tableMaterielService, "libarticle")).toString());
