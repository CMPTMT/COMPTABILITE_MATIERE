...
public class Modification2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-567)/2, (screenSize.height-516)/2, 567, 516);
...
SECTEURACTIVITE secteuractiviteF = new SECTEURACTIVITE();
  ArrayList tab = new ArrayList();
    ...
    try {
            ...
            codetypesecteur.setSelectedItem(secteuractiviteF.getOneResult("select LIBSECTEUR from SECTEURACTIVITE where IDSECTEUR="+Mf.SECTEURACTIVITE));
        ...
        codesecteur.setText(Mf.SECTEURACTIVITE);
        codesecteur.setVisible(false);
