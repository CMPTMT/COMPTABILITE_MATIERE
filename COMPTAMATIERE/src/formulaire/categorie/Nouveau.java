...
ArrayList elP,elD;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Code catégorie");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtCategorie, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(codeC, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setBounds((screenSize.width-601)/2, (screenSize.height-348)/2, 601, 348);
 ...
 CATEGORIE c= new CATEGORIE();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(reponse==JOptionPane.YES_OPTION){
            try {
                String valeur[]={codeC.getText(),codeD.getText(),txtCategorie.getText(),txtDureVie.getText(),codeIcat.getText()};
                int i=c.Insertion("CATEGORIE(IDCATEGORIE, idCOMPTED, LIBCATEGORIE, DUREEVIE,CODEICAT)",valeur);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        try {
            elP=c.getComboELement("select idFAMILLE,LIBFAMILLE from Famille order by LIBFAMILLE",cmbFamille);
             elD=c.getComboELement("select idCOMPTED,LIBCOMPTED from compted  order by libcompted",cmbCompteD);
